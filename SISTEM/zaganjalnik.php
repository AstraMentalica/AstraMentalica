...
// Naloži .env datoteko (Google OAuth ključi, DB, itd.)
if (function_exists('env_nalozi')) {
    $envPot = defined('PODATKI_ENV') ? PODATKI_ENV . '/.env_sistem' : '';
    if ($envPot && file_exists($envPot)) {
        env_nalozi($envPot);
    }
}
