 ...
 * POT: MODULI/Samanizem/AfricanaMystica/modul.php
...
function _modul_africanamystica_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'id'        => 'africanamystica',
        'verzija'   => '1.0.0',
        'opis'      => 'Africana Mystica — afriške duhovne tradicije. Ubuntu, animizem, predniški duhovi.',
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $podatki = $_REQUEST;
    $odziv   = modul_africanamystica_akcija($akcija, $podatki);
