 ...
 *
 * 📰 NAMEN:
 *     Živalski vodniki — totemske živali, šamanistična tradicija živalskih duhov.
 *
 * 🔧 JAVNE FUNKCIJE:
...
function _modul_animaris_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'kategorija'=> 'Samanizem',
        'verzija'   => '1.0.0',
        'opis'      => 'Živalski vodniki — totemske živali, šamanistična tradicija živalskih duhov.',
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $odziv   = modul_animaris_akcija($akcija, $_REQUEST);
