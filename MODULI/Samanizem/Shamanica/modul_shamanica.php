...
class ModulShamanica {
    ...
    public function pridobiVsebino(array $param = []): array {
        $html = "<div class='modul-shamanica'>" . htmlspecialchars($this->config['opis'] ?? '') . "</div>";
        return ['naslov' => $this->config['opis'] ?? 'Shamanica', 'vsebina' => $html];
    }
