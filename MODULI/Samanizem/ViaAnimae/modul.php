 ...
 *
 * 📰 NAMEN:
 *     Pot duše — šamanistična tradicija poti duše in medduhovnih potovanj.
 *
 * 🔧 JAVNE FUNKCIJE:
 *     - modul_viaanimae_akcija(string $akcija, array $podatki): array
 *
 * 📡 ODVISNOSTI:
 *     - Modul_Bridge
 *
...
function _modul_viaanimae_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'kategorija'=> 'Samanizem',
        'verzija'   => '1.0.0',
        'opis'      => 'Pot duše — šamanistična tradicija poti duše in medduhovnih potovanj.',
        'uporabnik' => $uporabnik['ime'] ?? 'Gost',
    ], 'Informacije o modulu');
}

function _modul_viaanimae_domov(array $podatki): array {
    return odziv_uspeh([
        'sporocilo' => 'Pozdravljen v modulu ViaAnimae!',
        'cas'       => time(),
    ], 'Domov');
}
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $odziv   = modul_viaanimae_akcija($akcija, $_REQUEST);
