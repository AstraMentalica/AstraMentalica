 ...
 *
 * 🔧 JAVNE FUNKCIJE:
 *     - modul_cosmicascientia_akcija(string $akcija, array $podatki): array
 *
 * 📡 ODVISNOSTI:
 *     - Modul_Bridge
 *
...
function _modul_cosmicascientia_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'kategorija'=> 'Znanost',
        'verzija'   => '1.0.0',
        'opis'      => 'Kozmična znanost — bioritem, Schumannove resonance in kozmobiologija.',
        'uporabnik' => $uporabnik['ime'] ?? 'Gost',
    ], 'Informacije o modulu');
}

function _modul_cosmicascientia_domov(array $podatki): array {
    return odziv_uspeh([
        'sporocilo' => 'Pozdravljen v modulu CosmicaScientia!',
        'cas'       => time(),
    ], 'Domov');
}
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $odziv   = modul_cosmicascientia_akcija($akcija, $_REQUEST);
