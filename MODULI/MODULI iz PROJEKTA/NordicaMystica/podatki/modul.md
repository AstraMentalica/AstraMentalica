...
1. Kopiraj mapo modula v `MODULI/nordicamystica/`
...
```bash
curl http://example.com/nordica/interpretacija
curl http://example.com/nordica/metanje
curl http://example.com/nordica/rune
```
...
```bash
curl -X GET http://example.com/nordica/interpretacija
```