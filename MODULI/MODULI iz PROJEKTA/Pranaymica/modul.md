...
Meditacija, dihalne tehnike in 7-dnevni vodič.
...
1. Kopiraj mapo modula v `MODULI/pranaymica/`
...
```bash
curl http://example.com/pranaymica/dihanje
curl http://example.com/pranaymica/meditacije
curl http://example.com/pranaymica/vodic
```
...
```bash
curl -X GET http://example.com/pranaymica/dihanje
```