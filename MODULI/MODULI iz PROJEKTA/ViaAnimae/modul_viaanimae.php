...
class ModulViaAnimae {
    ...
    public function pridobiVsebino($param = []) {
        $html = \"<div class='modul-viaanimae'>\" . htmlspecialchars($this->config['opis'] ?? '') . \"</div>\";
        return ['naslov' => $this->config['opis'] ?? 'ViaAnimae', 'vsebina' => $html];
    }
