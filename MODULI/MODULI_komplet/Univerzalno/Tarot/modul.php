...
/**
 * MODUL: Tarot
 * POT: MODULI/Univerzalno/Tarot/modul.php
 * 📅 VERZIJA: v1.0.0 (2026-06-28)
 * 📰 NAMEN: Tarot — arhetipske karte, razlage in globinska simbolika.
 * 👤 AVTOR: Damir Šafarič
 */
...
function modul_tarot_akcija(string $akcija, array $podatki = []): array {
...
function _modul_tarot_info(array $p): array {
    return odziv_uspeh(["ime"=>"Tarot","id"=>"tarot","verzija"=>"1.0.0","opis"=>"Tarot — arhetipske karte, razlage in globinska simbolika.","uporabnik"=>Modul_Bridge::uporabnik_pridobi()["ime"] ?? "Gost"], "Informacije");
}
function _modul_tarot_domov(array $p): array {
    return odziv_uspeh(["sporocilo"=>"Pozdravljen v Tarot!","cas"=>time()], "Domov");
}

if (basename($_SERVER["SCRIPT_FILENAME"] ?? "") === "modul.php" && !defined("SISTEM_OBSTAJA")) {
    $odziv = modul_tarot_akcija($_REQUEST["akcija"] ?? "domov", $_REQUEST);
