...
/**
 * MODUL: ViaAnimae
 * POT: MODULI/Univerzalno/ViaAnimae/modul.php
 * 📅 VERZIJA: v1.0.0 (2026-06-28)
 * 📰 NAMEN: Pot duše — karmični vzorci, namen duše in akašični zapisi.
 * 👤 AVTOR: Damir Šafarič
 */
...
function _modul_viaanimae_info(array $p): array {
    return odziv_uspeh(["ime"=>"ViaAnimae","id"=>"viaanimae","verzija"=>"1.0.0","opis"=>"Pot duše — karmični vzorci, namen duše in akašični zapisi.","uporabnik"=>Modul_Bridge::uporabnik_pridobi()["ime"] ?? "Gost"], "Informacije");
}
