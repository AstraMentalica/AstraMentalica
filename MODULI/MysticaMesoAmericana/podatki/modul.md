...
Mayanski koledar in bogovi Mezoamerike.
...
1. Kopiraj mapo modula v `MODULI/mysticamesoamericana/`
...
```bash
curl http://example.com/mesoamerica/bogovi
curl http://example.com/mesoamerica/koledar
curl http://example.com/mesoamerica/simboli
```
...
```bash
curl -X GET http://example.com/mesoamerica/bogovi
```