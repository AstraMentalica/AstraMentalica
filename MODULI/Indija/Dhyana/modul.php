 ...
 *
 * 📰 NAMEN:
 *     Meditacija — vipassana, transcendentalna in vedantska meditacija.
 *
 * 🔧 JAVNE FUNKCIJE:
 *     - modul_dhyana_akcija(string $akcija, array $podatki): array
 *
 * 📡 ODVISNOSTI:
 *     - Modul_Bridge
 *
...
function _modul_dhyana_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'kategorija'=> 'Indija',
        'verzija'   => '1.0.0',
        'opis'      => 'Meditacija — vipassana, transcendentalna in vedantska meditacija.',
        'uporabnik' => $uporabnik['ime'] ?? 'Gost',
    ], 'Informacije o modulu');
}

function _modul_dhyana_domov(array $podatki): array {
    return odziv_uspeh([
        'sporocilo' => 'Pozdravljen v modulu Dhyana!',
        'cas'       => time(),
    ], 'Domov');
}
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $odziv   = modul_dhyana_akcija($akcija, $_REQUEST);
