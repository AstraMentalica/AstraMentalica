 ...
 *
 * 📰 NAMEN:
 *     Ajurveda — starodavna indijska medicina, doshe in ravnovesje.
 *
 * 🔧 JAVNE FUNKCIJE:
 *     - modul_ayurveda_akcija(string $akcija, array $podatki): array
 *
 * 📡 ODVISNOSTI:
 *     - Modul_Bridge
 *
...
function _modul_ayurveda_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'kategorija'=> 'Indija',
        'verzija'   => '1.0.0',
        'opis'      => 'Ajurveda — starodavna indijska medicina, doshe in ravnovesje.',
        'uporabnik' => $uporabnik['ime'] ?? 'Gost',
    ], 'Informacije o modulu');
}

function _modul_ayurveda_domov(array $podatki): array {
    return odziv_uspeh([
        'sporocilo' => 'Pozdravljen v modulu Ayurveda!',
        'cas'       => time(),
    ], 'Domov');
}
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $odziv   = modul_ayurveda_akcija($akcija, $_REQUEST);
