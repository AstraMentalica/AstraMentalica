 ...
 *
 * 📰 NAMEN:
 *     Dihalne tehnike — pranajama, kontrola diha in vitalne energije.
 *
 * 🔧 JAVNE FUNKCIJE:
 *     - modul_pranayama_akcija(string $akcija, array $podatki): array
 *
 * 📡 ODVISNOSTI:
 *     - Modul_Bridge
 *
...
function _modul_pranayama_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'kategorija'=> 'Indija',
        'verzija'   => '1.0.0',
        'opis'      => 'Dihalne tehnike — pranajama, kontrola diha in vitalne energije.',
        'uporabnik' => $uporabnik['ime'] ?? 'Gost',
    ], 'Informacije o modulu');
}

function _modul_pranayama_domov(array $podatki): array {
    return odziv_uspeh([
        'sporocilo' => 'Pozdravljen v modulu Pranayama!',
        'cas'       => time(),
    ], 'Domov');
}
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $odziv   = modul_pranayama_akcija($akcija, $_REQUEST);
