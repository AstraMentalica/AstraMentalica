 ...
 *
 * 📰 NAMEN:
 *     Sistem čaker — energijska telesa, čakre in kundalini.
 *
 * 🔧 JAVNE FUNKCIJE:
 *     - modul_chakravidya_akcija(string $akcija, array $podatki): array
 *
 * 📡 ODVISNOSTI:
 *     - Modul_Bridge
 *
...
function _modul_chakravidya_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'kategorija'=> 'Indija',
        'verzija'   => '1.0.0',
        'opis'      => 'Sistem čaker — energijska telesa, čakre in kundalini.',
        'uporabnik' => $uporabnik['ime'] ?? 'Gost',
    ], 'Informacije o modulu');
}

function _modul_chakravidya_domov(array $podatki): array {
    return odziv_uspeh([
        'sporocilo' => 'Pozdravljen v modulu ChakraVidya!',
        'cas'       => time(),
    ], 'Domov');
}
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $odziv   = modul_chakravidya_akcija($akcija, $_REQUEST);
