...
class ModulCodex {
    ...
    public function pridobiVsebino(array $param = []): array {
        $html = "<div class='modul-codex'>" . htmlspecialchars($this->config['opis'] ?? '') . "</div>";
        return ['naslov' => $this->config['opis'] ?? 'Codex', 'vsebina' => $html];
    }
