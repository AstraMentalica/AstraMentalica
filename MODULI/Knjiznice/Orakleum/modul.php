 ...
 *
 * 📰 NAMEN:
 *     Orakleum — orakeljna knjižnica. Prerokbe, divinacija in sistemi vedeževanja.
 *
 * 🔧 JAVNE FUNKCIJE:
...
function _modul_orakleum_info(array $podatki): array {
    $uporabnik = Modul_Bridge::uporabnik_pridobi();
    return odziv_uspeh([
        'ime'       => 'Orakleum',
        'id'        => 'orakleum',
        'verzija'   => '1.0.0',
        'opis'      => 'Orakleum — orakeljna knjižnica. Prerokbe, divinacija in sistemi vedeževanja.',
        'uporabnik' => $uporabnik['ime'] ?? 'Gost',
    ], 'Informacije o modulu');
}

function _modul_orakleum_domov(array $podatki): array {
    return odziv_uspeh([
