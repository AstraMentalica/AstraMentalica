...
class ModulCodexAntiqua {
    ...
    public function pridobiVsebino(array $param = []): array {
        $html = "<div class='modul-codexantiqua'>" . htmlspecialchars($this->config['opis'] ?? '') . "</div>";
        return ['naslov' => $this->config['opis'] ?? 'CodexAntiqua', 'vsebina' => $html];
    }
