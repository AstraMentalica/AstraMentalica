 ...
 *
 * 📰 NAMEN:
 *     Amazonski šamanizem — rastlinska medicina, ayahuasca in duhovni rituali.
 *
 * 🔧 JAVNE FUNKCIJE:
 *     - modul_amazoniasacra_akcija(string $akcija, array $podatki): array
 *
 * 📡 ODVISNOSTI:
 *     - Modul_Bridge
 *
 ...
 *
 * 🏷️ OZNAKE:
 *     modul, amazoniasacra, amerikaamazonija
 * ============================================================
 */
...
function _modul_amazoniasacra_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'kategorija'=> 'AmerikaAmazonija',
        'verzija'   => '1.0.0',
        'opis'      => 'Amazonski šamanizem — rastlinska medicina, ayahuasca in duhovni rituali.',
        'uporabnik' => $uporabnik['ime'] ?? 'Gost',
    ], 'Informacije o modulu');
}

function _modul_amazoniasacra_domov(array $podatki): array {
    return odziv_uspeh([
        'sporocilo' => 'Pozdravljen v modulu AmazoniaSacra!',
        'cas'       => time(),
    ], 'Domov');
}
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $odziv   = modul_amazoniasacra_akcija($akcija, $_REQUEST);
