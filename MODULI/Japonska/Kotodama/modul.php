 ...
 *
 * 📰 NAMEN:
 *     Moč besed — japonska tradicija zvočne magije in moči besed.
 *
 * 🔧 JAVNE FUNKCIJE:
 *     - modul_kotodama_akcija(string $akcija, array $podatki): array
 *
 * 📡 ODVISNOSTI:
 *     - Modul_Bridge
 *
...
function _modul_kotodama_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'kategorija'=> 'Japonska',
        'verzija'   => '1.0.0',
        'opis'      => 'Moč besed — japonska tradicija zvočne magije in moči besed.',
        'uporabnik' => $uporabnik['ime'] ?? 'Gost',
    ], 'Informacije o modulu');
}

function _modul_kotodama_domov(array $podatki): array {
    return odziv_uspeh([
        'sporocilo' => 'Pozdravljen v modulu Kotodama!',
        'cas'       => time(),
    ], 'Domov');
}
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $odziv   = modul_kotodama_akcija($akcija, $_REQUEST);
