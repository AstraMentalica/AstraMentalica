 ...
 *
 * 🔧 JAVNE FUNKCIJE:
 *     - modul_reiki_akcija(string $akcija, array $podatki): array
 *
 * 📡 ODVISNOSTI:
 *     - Modul_Bridge
 *
...
function _modul_reiki_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'kategorija'=> 'Japonska',
        'verzija'   => '1.0.0',
        'opis'      => 'Reiki — japonska tehnika energijskega zdravljenja in ravnovesja.',
        'uporabnik' => $uporabnik['ime'] ?? 'Gost',
    ], 'Informacije o modulu');
}

function _modul_reiki_domov(array $podatki): array {
    return odziv_uspeh([
        'sporocilo' => 'Pozdravljen v modulu Reiki!',
        'cas'       => time(),
    ], 'Domov');
}
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $odziv   = modul_reiki_akcija($akcija, $_REQUEST);
