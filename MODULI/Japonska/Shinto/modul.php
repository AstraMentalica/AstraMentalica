 ...
 *
 * 📰 NAMEN:
 *     Šintoizem — japonska naravna duhovnost, kami in svetišča.
 *
 * 🔧 JAVNE FUNKCIJE:
 *     - modul_shinto_akcija(string $akcija, array $podatki): array
 *
 * 📡 ODVISNOSTI:
 *     - Modul_Bridge
 *
...
function _modul_shinto_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'kategorija'=> 'Japonska',
        'verzija'   => '1.0.0',
        'opis'      => 'Šintoizem — japonska naravna duhovnost, kami in svetišča.',
        'uporabnik' => $uporabnik['ime'] ?? 'Gost',
    ], 'Informacije o modulu');
}

function _modul_shinto_domov(array $podatki): array {
    return odziv_uspeh([
        'sporocilo' => 'Pozdravljen v modulu Shinto!',
        'cas'       => time(),
    ], 'Domov');
}
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $odziv   = modul_shinto_akcija($akcija, $_REQUEST);
