 ...
 * JSON BAZA: modul_umerariumosmicum_jsonbaza.php
...
class ModulUmerariumosmicumBaza {
    ...
    private function privzeto(): array {
        return [
            'ime' => 'NumerariumCosmicum', 'id' => 'umerariumosmicum', 'verzija' => '1.0.0',
            'tip' => 'divinacija', 'vnosov' => 0,
