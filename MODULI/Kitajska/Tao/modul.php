 ...
 *
 * 📰 NAMEN:
 *     Pot Tao — taoizem, wu wei, naravna pot in ravnovesje nasprotij.
 *
 * 🔧 JAVNE FUNKCIJE:
 *     - modul_tao_akcija(string $akcija, array $podatki): array
 *
 * 📡 ODVISNOSTI:
 *     - Modul_Bridge
 *
...
function _modul_tao_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'kategorija'=> 'Kitajska',
        'verzija'   => '1.0.0',
        'opis'      => 'Pot Tao — taoizem, wu wei, naravna pot in ravnovesje nasprotij.',
        'uporabnik' => $uporabnik['ime'] ?? 'Gost',
    ], 'Informacije o modulu');
}

function _modul_tao_domov(array $podatki): array {
    return odziv_uspeh([
        'sporocilo' => 'Pozdravljen v modulu Tao!',
        'cas'       => time(),
    ], 'Domov');
}
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $odziv   = modul_tao_akcija($akcija, $_REQUEST);
