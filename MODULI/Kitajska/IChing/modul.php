 ...
 *
 * 📰 NAMEN:
 *     Knjiga sprememb — I Ching, trigrami, heksagrami in kitajska prerokba.
 *
 * 🔧 JAVNE FUNKCIJE:
 *     - modul_iching_akcija(string $akcija, array $podatki): array
 *
 * 📡 ODVISNOSTI:
 *     - Modul_Bridge
 *
...
function _modul_iching_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'kategorija'=> 'Kitajska',
        'verzija'   => '1.0.0',
        'opis'      => 'Knjiga sprememb — I Ching, trigrami, heksagrami in kitajska prerokba.',
        'uporabnik' => $uporabnik['ime'] ?? 'Gost',
    ], 'Informacije o modulu');
}

function _modul_iching_domov(array $podatki): array {
    return odziv_uspeh([
        'sporocilo' => 'Pozdravljen v modulu IChing!',
        'cas'       => time(),
    ], 'Domov');
}
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $odziv   = modul_iching_akcija($akcija, $_REQUEST);
