 ...
 *
 * 📰 NAMEN:
 *     Pet elementov — les, ogenj, zemlja, kovina, voda in njihove interakcije.
 *
 * 🔧 JAVNE FUNKCIJE:
 *     - modul_wuxing_akcija(string $akcija, array $podatki): array
 *
 * 📡 ODVISNOSTI:
 *     - Modul_Bridge
 *
...
function _modul_wuxing_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'kategorija'=> 'Kitajska',
        'verzija'   => '1.0.0',
        'opis'      => 'Pet elementov — les, ogenj, zemlja, kovina, voda in njihove interakcije.',
        'uporabnik' => $uporabnik['ime'] ?? 'Gost',
    ], 'Informacije o modulu');
}

function _modul_wuxing_domov(array $podatki): array {
    return odziv_uspeh([
        'sporocilo' => 'Pozdravljen v modulu WuXing!',
        'cas'       => time(),
    ], 'Domov');
}
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $odziv   = modul_wuxing_akcija($akcija, $_REQUEST);
