 ...
 *
 * 📰 NAMEN:
 *     Življenjska energija — qi gong, življenjska sila in kitajska energetika.
 *
 * 🔧 JAVNE FUNKCIJE:
 *     - modul_qi_akcija(string $akcija, array $podatki): array
 *
 * 📡 ODVISNOSTI:
 *     - Modul_Bridge
 *
...
function _modul_qi_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'kategorija'=> 'Kitajska',
        'verzija'   => '1.0.0',
        'opis'      => 'Življenjska energija — qi gong, življenjska sila in kitajska energetika.',
        'uporabnik' => $uporabnik['ime'] ?? 'Gost',
    ], 'Informacije o modulu');
}

function _modul_qi_domov(array $podatki): array {
    return odziv_uspeh([
        'sporocilo' => 'Pozdravljen v modulu Qi!',
        'cas'       => time(),
    ], 'Domov');
}
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $odziv   = modul_qi_akcija($akcija, $_REQUEST);
