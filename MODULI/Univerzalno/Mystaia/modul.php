 ...
 *
 * 📰 NAMEN:
 *     Notranji misteriji — iniciacije, mistični poti in notranje transformacije.
 *
 * 🔧 JAVNE FUNKCIJE:
 *     - modul_mystaia_akcija(string $akcija, array $podatki): array
 *
 * 📡 ODVISNOSTI:
 *     - Modul_Bridge
 *
...
function _modul_mystaia_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'kategorija'=> 'Univerzalno',
        'verzija'   => '1.0.0',
        'opis'      => 'Notranji misteriji — iniciacije, mistični poti in notranje transformacije.',
        'uporabnik' => $uporabnik['ime'] ?? 'Gost',
    ], 'Informacije o modulu');
}

function _modul_mystaia_domov(array $podatki): array {
    return odziv_uspeh([
        'sporocilo' => 'Pozdravljen v modulu Mystaia!',
        'cas'       => time(),
    ], 'Domov');
}
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $odziv   = modul_mystaia_akcija($akcija, $_REQUEST);
