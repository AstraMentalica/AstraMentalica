 ...
 *
 * 🏷️ OZNAKE:
 *     modul, corpusmysticum, univerzalno
 * ============================================================
 */
...
function _modul_corpusmysticum_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'kategorija'=> 'Univerzalno',
        'verzija'   => '1.0.0',
        'opis'      => 'Mistično telo — enciklopedija ezoteričnih znanj, simbolov in tradicij.',
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $odziv   = modul_corpusmysticum_akcija($akcija, $_REQUEST);
