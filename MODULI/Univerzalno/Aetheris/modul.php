 ...
 *
 * 📰 NAMEN:
 *     Eter in višje ravni — energijsko polje, avra, barvna analiza in čiščenje polja.
 *
 * 🔧 JAVNE FUNKCIJE:
...
function _modul_aetheris_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'kategorija'=> 'Univerzalno',
        'verzija'   => '1.0.0',
        'opis'      => 'Eter in višje ravni — energijsko polje, avra, barvna analiza in čiščenje polja.',
...
function _modul_aetheris_domov(array $podatki): array {
    return odziv_uspeh([
        'sporocilo' => 'Pozdravljen v modulu Aetheris!',
        'cas'       => time(),
    ], 'Domov');
}
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $odziv   = modul_aetheris_akcija($akcija, $_REQUEST);
