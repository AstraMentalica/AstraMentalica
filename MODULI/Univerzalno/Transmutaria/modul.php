 ...
 *
 * 📰 NAMEN:
 *     Notranja preobrazba — alkimija duše, proces osebne transformacije.
 *
 * 🔧 JAVNE FUNKCIJE:
 *     - modul_transmutaria_akcija(string $akcija, array $podatki): array
 *
 * 📡 ODVISNOSTI:
 *     - Modul_Bridge
 *
 ...
 *
 * 🏷️ OZNAKE:
 *     modul, transmutaria, univerzalno
 * ============================================================
 */
...
function _modul_transmutaria_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'kategorija'=> 'Univerzalno',
        'verzija'   => '1.0.0',
        'opis'      => 'Notranja preobrazba — alkimija duše, proces osebne transformacije.',
        'uporabnik' => $uporabnik['ime'] ?? 'Gost',
    ], 'Informacije o modulu');
}

function _modul_transmutaria_domov(array $podatki): array {
    return odziv_uspeh([
        'sporocilo' => 'Pozdravljen v modulu Transmutaria!',
        'cas'       => time(),
    ], 'Domov');
}
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $odziv   = modul_transmutaria_akcija($akcija, $_REQUEST);
