 ...
 *
 * 📰 NAMEN:
 *     Energijske prakse — delo z energijo, bioenergetika in energijska polja.
 *
 * 🔧 JAVNE FUNKCIJE:
...
function _modul_energetica_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'kategorija'=> 'Univerzalno',
        'verzija'   => '1.0.0',
        'opis'      => 'Energijske prakse — delo z energijo, bioenergetika in energijska polja.',
...
function _modul_energetica_domov(array $podatki): array {
    return odziv_uspeh([
        'sporocilo' => 'Pozdravljen v modulu Energetica!',
        'cas'       => time(),
    ], 'Domov');
}
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $odziv   = modul_energetica_akcija($akcija, $_REQUEST);
