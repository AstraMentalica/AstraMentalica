 ...
 *
 * 📰 NAMEN:
 *     Svete frekvence — zvočne vibracije, nada yoga in kozmični zvok.
 *
 * 🔧 JAVNE FUNKCIJE:
 *     - modul_nadabrahma_akcija(string $akcija, array $podatki): array
 *
 * 📡 ODVISNOSTI:
 *     - Modul_Bridge
 *
...
function _modul_nadabrahma_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'kategorija'=> 'Univerzalno',
        'verzija'   => '1.0.0',
        'opis'      => 'Svete frekvence — zvočne vibracije, nada yoga in kozmični zvok.',
        'uporabnik' => $uporabnik['ime'] ?? 'Gost',
    ], 'Informacije o modulu');
}

function _modul_nadabrahma_domov(array $podatki): array {
    return odziv_uspeh([
        'sporocilo' => 'Pozdravljen v modulu NadaBrahma!',
        'cas'       => time(),
    ], 'Domov');
}
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $odziv   = modul_nadabrahma_akcija($akcija, $_REQUEST);
