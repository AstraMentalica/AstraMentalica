 ...
 *
 * 📰 NAMEN:
 *     Mistična zora — prehodna stanja zavesti, jutranje rituale in prebujenje.
 *
 * 🔧 JAVNE FUNKCIJE:
 *     - modul_auroramystica_akcija(string $akcija, array $podatki): array
 *
 * 📡 ODVISNOSTI:
 *     - Modul_Bridge
 *
 ...
 *
 * 🏷️ OZNAKE:
 *     modul, auroramystica, univerzalno
 * ============================================================
 */
...
function _modul_auroramystica_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'kategorija'=> 'Univerzalno',
        'verzija'   => '1.0.0',
        'opis'      => 'Mistična zora — prehodna stanja zavesti, jutranje rituale in prebujenje.',
        'uporabnik' => $uporabnik['ime'] ?? 'Gost',
    ], 'Informacije o modulu');
}

function _modul_auroramystica_domov(array $podatki): array {
    return odziv_uspeh([
        'sporocilo' => 'Pozdravljen v modulu AuroraMystica!',
        'cas'       => time(),
    ], 'Domov');
}
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $odziv   = modul_auroramystica_akcija($akcija, $_REQUEST);
