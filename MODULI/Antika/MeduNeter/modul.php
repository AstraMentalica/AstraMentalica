 ...
 *
 * 📰 NAMEN:
 *     Hieroglifi — sveto egipčansko pismo, simboli in njihov mistični pomen.
 *
 * 🔧 JAVNE FUNKCIJE:
 *     - modul_meduneter_akcija(string $akcija, array $podatki): array
 *
 * 📡 ODVISNOSTI:
 *     - Modul_Bridge
 *
...
function _modul_meduneter_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'kategorija'=> 'Antika',
        'verzija'   => '1.0.0',
        'opis'      => 'Hieroglifi — sveto egipčansko pismo, simboli in njihov mistični pomen.',
        'uporabnik' => $uporabnik['ime'] ?? 'Gost',
    ], 'Informacije o modulu');
}

function _modul_meduneter_domov(array $podatki): array {
    return odziv_uspeh([
        'sporocilo' => 'Pozdravljen v modulu MeduNeter!',
        'cas'       => time(),
    ], 'Domov');
}
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $odziv   = modul_meduneter_akcija($akcija, $_REQUEST);
