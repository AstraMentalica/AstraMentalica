 ...
 *
 * 📰 NAMEN:
 *     Labirint zavesti — grški labirint kot metafora duhovne poti.
 *
 * 🔧 JAVNE FUNKCIJE:
 *     - modul_labyrinthos_akcija(string $akcija, array $podatki): array
 *
 * 📡 ODVISNOSTI:
 *     - Modul_Bridge
 *
...
function _modul_labyrinthos_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'kategorija'=> 'Antika',
        'verzija'   => '1.0.0',
        'opis'      => 'Labirint zavesti — grški labirint kot metafora duhovne poti.',
        'uporabnik' => $uporabnik['ime'] ?? 'Gost',
    ], 'Informacije o modulu');
}

function _modul_labyrinthos_domov(array $podatki): array {
    return odziv_uspeh([
        'sporocilo' => 'Pozdravljen v modulu Labyrinthos!',
        'cas'       => time(),
    ], 'Domov');
}
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $odziv   = modul_labyrinthos_akcija($akcija, $_REQUEST);
