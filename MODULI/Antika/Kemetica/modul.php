 ...
 *
 * 📰 NAMEN:
 *     Egipčanske skrivnosti — hermetizem, hieroglifi in starodavna modrost Kemeta.
 *
 * 🔧 JAVNE FUNKCIJE:
 *     - modul_kemetica_akcija(string $akcija, array $podatki): array
 *
 * 📡 ODVISNOSTI:
 *     - Modul_Bridge
 *
...
function _modul_kemetica_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'kategorija'=> 'Antika',
        'verzija'   => '1.0.0',
        'opis'      => 'Egipčanske skrivnosti — hermetizem, hieroglifi in starodavna modrost Kemeta.',
        'uporabnik' => $uporabnik['ime'] ?? 'Gost',
    ], 'Informacije o modulu');
}

function _modul_kemetica_domov(array $podatki): array {
    return odziv_uspeh([
        'sporocilo' => 'Pozdravljen v modulu Kemetica!',
        'cas'       => time(),
    ], 'Domov');
}
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $odziv   = modul_kemetica_akcija($akcija, $_REQUEST);
