 ...
 *
 * 📰 NAMEN:
 *     Razlaga sanj — grška tradicija sanjskih prerokb in interpretacij.
 *
 * 🔧 JAVNE FUNKCIJE:
 *     - modul_oneiros_akcija(string $akcija, array $podatki): array
 *
 * 📡 ODVISNOSTI:
 *     - Modul_Bridge
 *
...
function _modul_oneiros_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'kategorija'=> 'Antika',
        'verzija'   => '1.0.0',
        'opis'      => 'Razlaga sanj — grška tradicija sanjskih prerokb in interpretacij.',
        'uporabnik' => $uporabnik['ime'] ?? 'Gost',
    ], 'Informacije o modulu');
}

function _modul_oneiros_domov(array $podatki): array {
    return odziv_uspeh([
        'sporocilo' => 'Pozdravljen v modulu Oneiros!',
        'cas'       => time(),
    ], 'Domov');
}
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $odziv   = modul_oneiros_akcija($akcija, $_REQUEST);
