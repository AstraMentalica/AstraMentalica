 ...
 *
 * 📰 NAMEN:
 *     Pot skozi podzemlje — egipčanska knjiga mrtvih, Amduat in pot duše.
 *
 * 🔧 JAVNE FUNKCIJE:
 *     - modul_duat_akcija(string $akcija, array $podatki): array
 *
 * 📡 ODVISNOSTI:
 *     - Modul_Bridge
 *
...
function _modul_duat_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'kategorija'=> 'Antika',
        'verzija'   => '1.0.0',
        'opis'      => 'Pot skozi podzemlje — egipčanska knjiga mrtvih, Amduat in pot duše.',
        'uporabnik' => $uporabnik['ime'] ?? 'Gost',
    ], 'Informacije o modulu');
}

function _modul_duat_domov(array $podatki): array {
    return odziv_uspeh([
        'sporocilo' => 'Pozdravljen v modulu Duat!',
        'cas'       => time(),
    ], 'Domov');
}
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $odziv   = modul_duat_akcija($akcija, $_REQUEST);
