 ...
 *
 * 📰 NAMEN:
 *     Duhovni vodniki — grška tradicija osebnega duha in notranjega vodnika.
 *
 * 🔧 JAVNE FUNKCIJE:
 *     - modul_daimon_akcija(string $akcija, array $podatki): array
 *
 * 📡 ODVISNOSTI:
 *     - Modul_Bridge
 *
...
function _modul_daimon_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'kategorija'=> 'Antika',
        'verzija'   => '1.0.0',
        'opis'      => 'Duhovni vodniki — grška tradicija osebnega duha in notranjega vodnika.',
        'uporabnik' => $uporabnik['ime'] ?? 'Gost',
    ], 'Informacije o modulu');
}

function _modul_daimon_domov(array $podatki): array {
    return odziv_uspeh([
        'sporocilo' => 'Pozdravljen v modulu Daimon!',
        'cas'       => time(),
    ], 'Domov');
}
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $odziv   = modul_daimon_akcija($akcija, $_REQUEST);
