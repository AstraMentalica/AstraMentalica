 ...
 *
 * 📰 NAMEN:
 *     Angelske hierarhije — angelski redi, arhangeli in nebeška hierarhija.
 *
 * 🔧 JAVNE FUNKCIJE:
 *     - modul_malakhim_akcija(string $akcija, array $podatki): array
 *
 * 📡 ODVISNOSTI:
 *     - Modul_Bridge
 *
 ...
 *
 * 🏷️ OZNAKE:
 *     modul, malakhim, hebrejskamistika
 * ============================================================
 */
...
function _modul_malakhim_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'kategorija'=> 'HebrejskaMistika',
        'verzija'   => '1.0.0',
        'opis'      => 'Angelske hierarhije — angelski redi, arhangeli in nebeška hierarhija.',
        'uporabnik' => $uporabnik['ime'] ?? 'Gost',
    ], 'Informacije o modulu');
}

function _modul_malakhim_domov(array $podatki): array {
    return odziv_uspeh([
        'sporocilo' => 'Pozdravljen v modulu Malakhim!',
        'cas'       => time(),
    ], 'Domov');
}
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $odziv   = modul_malakhim_akcija($akcija, $_REQUEST);
