 ...
 *
 * 📰 NAMEN:
 *     Svet angelov — angelska sporočila, varstvo in komunikacija z angeli.
 *
 * 🔧 JAVNE FUNKCIJE:
 *     - modul_angelarium_akcija(string $akcija, array $podatki): array
 *
 * 📡 ODVISNOSTI:
 *     - Modul_Bridge
 *
 ...
 *
 * 🏷️ OZNAKE:
 *     modul, angelarium, hebrejskamistika
 * ============================================================
 */
...
function _modul_angelarium_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'kategorija'=> 'HebrejskaMistika',
        'verzija'   => '1.0.0',
        'opis'      => 'Svet angelov — angelska sporočila, varstvo in komunikacija z angeli.',
        'uporabnik' => $uporabnik['ime'] ?? 'Gost',
    ], 'Informacije o modulu');
}

function _modul_angelarium_domov(array $podatki): array {
    return odziv_uspeh([
        'sporocilo' => 'Pozdravljen v modulu Angelarium!',
        'cas'       => time(),
    ], 'Domov');
}
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $odziv   = modul_angelarium_akcija($akcija, $_REQUEST);
