 ...
 *
 * 📰 NAMEN:
 *     Kabala — mistični judaizem, Ein Sof in kozmična struktura stvarnosti.
 *
 * 🔧 JAVNE FUNKCIJE:
 *     - modul_kabbalah_akcija(string $akcija, array $podatki): array
 *
 * 📡 ODVISNOSTI:
 *     - Modul_Bridge
 *
 ...
 *
 * 🏷️ OZNAKE:
 *     modul, kabbalah, hebrejskamistika
 * ============================================================
 */
...
function _modul_kabbalah_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'kategorija'=> 'HebrejskaMistika',
        'verzija'   => '1.0.0',
        'opis'      => 'Kabala — mistični judaizem, Ein Sof in kozmična struktura stvarnosti.',
        'uporabnik' => $uporabnik['ime'] ?? 'Gost',
    ], 'Informacije o modulu');
}

function _modul_kabbalah_domov(array $podatki): array {
    return odziv_uspeh([
        'sporocilo' => 'Pozdravljen v modulu Kabbalah!',
        'cas'       => time(),
    ], 'Domov');
}
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $odziv   = modul_kabbalah_akcija($akcija, $_REQUEST);
