 ...
 *
 * 🔧 JAVNE FUNKCIJE:
 *     - modul_musok_akcija(string $akcija, array $podatki): array
 *
 * 📡 ODVISNOSTI:
 *     - Modul_Bridge
 *
...
function _modul_musok_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'kategorija'=> 'Koreja',
        'verzija'   => '1.0.0',
        'opis'      => 'Korejski šamanizem — mudang, duhovi prednikov in korejske duhovne prakse.',
        'uporabnik' => $uporabnik['ime'] ?? 'Gost',
    ], 'Informacije o modulu');
}

function _modul_musok_domov(array $podatki): array {
    return odziv_uspeh([
        'sporocilo' => 'Pozdravljen v modulu Musok!',
        'cas'       => time(),
    ], 'Domov');
}
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $odziv   = modul_musok_akcija($akcija, $_REQUEST);
