 ...
 *
 * 📰 NAMEN:
 *     Tradicionalna korejska medicina — hanbang, zeliščarstvo in energijsko zdravljenje.
 *
 * 🔧 JAVNE FUNKCIJE:
 *     - modul_hanbang_akcija(string $akcija, array $podatki): array
 *
 * 📡 ODVISNOSTI:
 *     - Modul_Bridge
 *
...
function _modul_hanbang_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'kategorija'=> 'Koreja',
        'verzija'   => '1.0.0',
        'opis'      => 'Tradicionalna korejska medicina — hanbang, zeliščarstvo in energijsko zdravljenje.',
        'uporabnik' => $uporabnik['ime'] ?? 'Gost',
    ], 'Informacije o modulu');
}

function _modul_hanbang_domov(array $podatki): array {
    return odziv_uspeh([
        'sporocilo' => 'Pozdravljen v modulu Hanbang!',
        'cas'       => time(),
    ], 'Domov');
}
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $odziv   = modul_hanbang_akcija($akcija, $_REQUEST);
