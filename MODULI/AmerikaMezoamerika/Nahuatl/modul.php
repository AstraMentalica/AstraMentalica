 ...
 *
 * 📰 NAMEN:
 *     Nahuatl — jezik in modrost nahuatl tradicije, tonal in nagual.
 *
 * 🔧 JAVNE FUNKCIJE:
 *     - modul_nahuatl_akcija(string $akcija, array $podatki): array
 *
 * 📡 ODVISNOSTI:
 *     - Modul_Bridge
 *
 ...
 *
 * 🏷️ OZNAKE:
 *     modul, nahuatl, amerikamezoamerika
 * ============================================================
 */
...
function _modul_nahuatl_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'kategorija'=> 'AmerikaMezoamerika',
        'verzija'   => '1.0.0',
        'opis'      => 'Nahuatl — jezik in modrost nahuatl tradicije, tonal in nagual.',
        'uporabnik' => $uporabnik['ime'] ?? 'Gost',
    ], 'Informacije o modulu');
}

function _modul_nahuatl_domov(array $podatki): array {
    return odziv_uspeh([
        'sporocilo' => 'Pozdravljen v modulu Nahuatl!',
        'cas'       => time(),
    ], 'Domov');
}
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $odziv   = modul_nahuatl_akcija($akcija, $_REQUEST);
