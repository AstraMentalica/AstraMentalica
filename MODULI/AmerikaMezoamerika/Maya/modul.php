 ...
 *
 * 📰 NAMEN:
 *     Maya — mayanski koledar, Tzolkin, Long Count in kozmični cikli.
 *
 * 🔧 JAVNE FUNKCIJE:
 *     - modul_maya_akcija(string $akcija, array $podatki): array
 *
 * 📡 ODVISNOSTI:
 *     - Modul_Bridge
 *
...
function _modul_maya_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'kategorija'=> 'AmerikaMezoamerika',
        'verzija'   => '1.0.0',
        'opis'      => 'Maya — mayanski koledar, Tzolkin, Long Count in kozmični cikli.',
        'uporabnik' => $uporabnik['ime'] ?? 'Gost',
    ], 'Informacije o modulu');
}

function _modul_maya_domov(array $podatki): array {
    return odziv_uspeh([
        'sporocilo' => 'Pozdravljen v modulu Maya!',
        'cas'       => time(),
    ], 'Domov');
}
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $odziv   = modul_maya_akcija($akcija, $_REQUEST);
