...
/**
 * MODUL: Codex
 * POT: MODULI/Codex/modul.php
 * VERZIJA: 1.0.0 (24.6.2026)
 *
 * 🏛️ NIVO: MODUL
 *
 * 📰 NAMEN:
 *     Standardna vstopna točka za Codex modul
...
function modul_codex_akcija(string $akcija, array $podatki = []): array {
    ...
    return match($akcija) {
        'info'  => _modul_codex_akcija_info($podatki),
        'domov' => _modul_codex_akcija_domov($podatki),
...
function _modul_codex_akcija_info(array $podatki): array {
    return odziv_uspeh([
        'ime'       => 'Codex',
        'id'        => 'codex',
        'verzija'   => '1.0.0',
...
function _modul_codex_akcija_domov(array $podatki): array {
    return odziv_uspeh([
