 ...
 *
 * 📰 NAMEN:
 *     Afriške tradicije — Yoruba, Voodoo, Ubuntu in afriška duhovna modrost.
 *
 * 🔧 JAVNE FUNKCIJE:
 *     - modul_africanamystica_akcija(string $akcija, array $podatki): array
 *
 * 📡 ODVISNOSTI:
 *     - Modul_Bridge
 *
 ...
 *
 * 🏷️ OZNAKE:
 *     modul, africanamystica, prihodnost
 * ============================================================
 */
...
function _modul_africanamystica_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'kategorija'=> 'Prihodnost',
        'verzija'   => '1.0.0',
        'opis'      => 'Afriške tradicije — Yoruba, Voodoo, Ubuntu in afriška duhovna modrost.',
        'uporabnik' => $uporabnik['ime'] ?? 'Gost',
    ], 'Informacije o modulu');
}

function _modul_africanamystica_domov(array $podatki): array {
    return odziv_uspeh([
        'sporocilo' => 'Pozdravljen v modulu AfricanaMystica!',
        'cas'       => time(),
    ], 'Domov');
}
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $odziv   = modul_africanamystica_akcija($akcija, $_REQUEST);
