 ...
 *
 * 📰 NAMEN:
 *     Hermetizem — hermetična filozofija, Corpus Hermeticum in Trismegist.
 *
 * 🔧 JAVNE FUNKCIJE:
 *     - modul_hermetica_akcija(string $akcija, array $podatki): array
 *
 * 📡 ODVISNOSTI:
 *     - Modul_Bridge
 *
...
function _modul_hermetica_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'kategorija'=> 'Prihodnost',
        'verzija'   => '1.0.0',
        'opis'      => 'Hermetizem — hermetična filozofija, Corpus Hermeticum in Trismegist.',
        'uporabnik' => $uporabnik['ime'] ?? 'Gost',
    ], 'Informacije o modulu');
}

function _modul_hermetica_domov(array $podatki): array {
    return odziv_uspeh([
        'sporocilo' => 'Pozdravljen v modulu Hermetica!',
        'cas'       => time(),
    ], 'Domov');
}
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $odziv   = modul_hermetica_akcija($akcija, $_REQUEST);
