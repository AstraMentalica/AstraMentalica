 ...
 *
 * 📰 NAMEN:
 *     Slovanska mistika — predkrščanska slovanska magija in misteriji.
 *
 * 🔧 JAVNE FUNKCIJE:
 *     - modul_slavicamystica_akcija(string $akcija, array $podatki): array
 *
 * 📡 ODVISNOSTI:
 *     - Modul_Bridge
 *
 ...
 *
 * 🏷️ OZNAKE:
 *     modul, slavicamystica, prihodnost
 * ============================================================
 */
...
function _modul_slavicamystica_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'kategorija'=> 'Prihodnost',
        'verzija'   => '1.0.0',
        'opis'      => 'Slovanska mistika — predkrščanska slovanska magija in misteriji.',
        'uporabnik' => $uporabnik['ime'] ?? 'Gost',
    ], 'Informacije o modulu');
}

function _modul_slavicamystica_domov(array $podatki): array {
    return odziv_uspeh([
        'sporocilo' => 'Pozdravljen v modulu SlavicaMystica!',
        'cas'       => time(),
    ], 'Domov');
}
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $odziv   = modul_slavicamystica_akcija($akcija, $_REQUEST);
