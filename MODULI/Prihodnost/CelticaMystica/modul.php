 ...
 *
 * 📰 NAMEN:
 *     Keltska mistika — globlja keltska ezoterika, druidska mistika.
 *
 * 🔧 JAVNE FUNKCIJE:
 *     - modul_celticamystica_akcija(string $akcija, array $podatki): array
 *
 * 📡 ODVISNOSTI:
 *     - Modul_Bridge
 *
 ...
 *
 * 🏷️ OZNAKE:
 *     modul, celticamystica, prihodnost
 * ============================================================
 */
...
function _modul_celticamystica_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'kategorija'=> 'Prihodnost',
        'verzija'   => '1.0.0',
        'opis'      => 'Keltska mistika — globlja keltska ezoterika, druidska mistika.',
        'uporabnik' => $uporabnik['ime'] ?? 'Gost',
    ], 'Informacije o modulu');
}

function _modul_celticamystica_domov(array $podatki): array {
    return odziv_uspeh([
        'sporocilo' => 'Pozdravljen v modulu CelticaMystica!',
        'cas'       => time(),
    ], 'Domov');
}
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $odziv   = modul_celticamystica_akcija($akcija, $_REQUEST);
