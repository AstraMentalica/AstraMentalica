 ...
 *
 * 📰 NAMEN:
 *     Polinezijska modrost — mana, tapu, Haka in polinezijska duhovna tradicija.
 *
 * 🔧 JAVNE FUNKCIJE:
 ...
 *
 * 🏷️ OZNAKE:
 *     modul, polynesiamystica, prihodnost
 * ============================================================
 */
...
function _modul_polynesiamystica_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'kategorija'=> 'Prihodnost',
        'verzija'   => '1.0.0',
        'opis'      => 'Polinezijska modrost — mana, tapu, Haka in polinezijska duhovna tradicija.',
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $odziv   = modul_polynesiamystica_akcija($akcija, $_REQUEST);
