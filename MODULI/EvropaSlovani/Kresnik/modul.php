 ...
 *
 * 🔧 JAVNE FUNKCIJE:
 *     - modul_kresnik_akcija(string $akcija, array $podatki): array
 *
 * 📡 ODVISNOSTI:
 *     - Modul_Bridge
 *
...
function _modul_kresnik_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'kategorija'=> 'EvropaSlovani',
        'verzija'   => '1.0.0',
        'opis'      => 'Slovenska mistika — Kresnik, Kurent in slovensko duhovno izročilo.',
        'uporabnik' => $uporabnik['ime'] ?? 'Gost',
    ], 'Informacije o modulu');
}

function _modul_kresnik_domov(array $podatki): array {
    return odziv_uspeh([
        'sporocilo' => 'Pozdravljen v modulu Kresnik!',
        'cas'       => time(),
    ], 'Domov');
}
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $odziv   = modul_kresnik_akcija($akcija, $_REQUEST);
