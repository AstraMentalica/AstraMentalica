 ...
 *
 * 🔧 JAVNE FUNKCIJE:
 *     - modul_rodnoverje_akcija(string $akcija, array $podatki): array
 *
 * 📡 ODVISNOSTI:
 *     - Modul_Bridge
 *
 ...
 *
 * 🏷️ OZNAKE:
 *     modul, rodnoverje, evropaslovani
 * ============================================================
 */
...
function _modul_rodnoverje_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'kategorija'=> 'EvropaSlovani',
        'verzija'   => '1.0.0',
        'opis'      => 'Slovansko staroverstvo — predkrščanska slovanska duhovnost in bogovi.',
        'uporabnik' => $uporabnik['ime'] ?? 'Gost',
    ], 'Informacije o modulu');
}

function _modul_rodnoverje_domov(array $podatki): array {
    return odziv_uspeh([
        'sporocilo' => 'Pozdravljen v modulu Rodnoverje!',
        'cas'       => time(),
    ], 'Domov');
}
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $odziv   = modul_rodnoverje_akcija($akcija, $_REQUEST);
