...
class ModulDruidica {
    ...
    public function pridobiVsebino(array $param = []): array {
        $html = "<div class='modul-druidica'>" . htmlspecialchars($this->config['opis'] ?? '') . "</div>";
        return ['naslov' => $this->config['opis'] ?? 'Druidica', 'vsebina' => $html];
    }
