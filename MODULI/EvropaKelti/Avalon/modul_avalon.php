...
class ModulAvalon {
    ...
    public function pridobiVsebino(array $param = []): array {
        $html = "<div class='modul-avalon'>" . htmlspecialchars($this->config['opis'] ?? '') . "</div>";
        return ['naslov' => $this->config['opis'] ?? 'Avalon', 'vsebina' => $html];
    }
