 ...
 *
 * 📰 NAMEN:
 *     Rune — nordijska runska pisava, Elder Futhark in runska magija.
 *
 * 🔧 JAVNE FUNKCIJE:
 *     - modul_runir_akcija(string $akcija, array $podatki): array
 *
 * 📡 ODVISNOSTI:
 *     - Modul_Bridge
 *
...
function _modul_runir_info(array $podatki): array {
    ...
    return odziv_uspeh([
        ...
        'kategorija'=> 'EvropaNordija',
        'verzija'   => '1.0.0',
        'opis'      => 'Rune — nordijska runska pisava, Elder Futhark in runska magija.',
        'uporabnik' => $uporabnik['ime'] ?? 'Gost',
    ], 'Informacije o modulu');
}

function _modul_runir_domov(array $podatki): array {
    return odziv_uspeh([
        'sporocilo' => 'Pozdravljen v modulu Runir!',
        'cas'       => time(),
    ], 'Domov');
}
...
if (basename($_SERVER['SCRIPT_FILENAME'] ?? '') === 'modul.php' && !defined('SISTEM_OBSTAJA')) {
    ...
    $odziv   = modul_runir_akcija($akcija, $_REQUEST);
