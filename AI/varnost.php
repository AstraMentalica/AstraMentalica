<?php
/**   varnost.php naj vključuje pot.php in nato pot_ai.php, vsi AI pa naj vključujejo varnost ostalo pa preko konstant iz pot_ai.php
 * ============================================================
 * POT: AI/varnost.php
...
$PISANJE_DOVOLJENO = [
    ...
    "MODULI/",
    "UPORABNIKI/",
    "AI/zasebniAi/sistemskiAi/naloge/",      // poročila, backupi, patchi agentov
];
...
$SAMO_BRANJE = [
    "PODATKI/",
    "VSEBINA/",
    "AI/zasebniAi/sistemskiAi/pravila/",
    "AI/zasebniAi/sistemskiAi/agentni_manifesti/",
];
