...
function _render_vsebina(string $tip, array $vsebina): void
{
    $prikazDatoteke = match ($tip) {
        'domov'      => __DIR__ . '/strani/domov.php',
        'modul'      => __DIR__ . '/strani/modul.php',
        'moduli'     => __DIR__ . '/strani/moduli_seznam.php',
        'profil'     => __DIR__ . '/strani/profil.php',
        'passport'   => __DIR__ . '/strani/passport.php',
        'nastavitve' => __DIR__ . '/strani/nastavitve.php',
        'napaka'     => __DIR__ . '/strani/napaka.php',
        'prijava'    => __DIR__ . '/strani/prijava.php',
        default      => null,
    };
