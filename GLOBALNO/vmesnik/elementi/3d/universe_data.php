...
// Helper za klic modula — najprej poskusi API, potem direktno
function modulAkcija(string $imeModula, string $akcija, array $podatki): array {
    // Najprej poskusi prek API
    if (function_exists('apiKlic')) {
