<?php
/**
 * POT: ASTRA/astraCenter.php | VERZIJA: v116
...
<div class="mreza-2">
    ...
    <a href="?svet=ASTRA&orodje=projekt_skener" class="kartica kartica-klik">
        <div class="kartica-ikona">🗺️</div>
        <h3>Projekt skener</h3>
        <p>Ustvari zemljevid projekta za AI agente. Avtomatski scan ali ročni vnos drevesne strukture.</p>
    </a>
