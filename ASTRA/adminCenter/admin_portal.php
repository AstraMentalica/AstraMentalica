<?php
/**
 * ASTRA/admin/admin_portal.php
 * Admin portal — premium kode, magični portali, sistem
 * Usklajen z AstraMentalica arhitekturo (v115)
 */
...
// RBAC – samo S5 / admin (v115: VLOGA_S5 = 60)
...
// v115: PODATKI_JSON -> POT_PODATKI . '/json'
...
if (isset($_GET['toggle_portal'])) {
    ...
    adm_pisi($PORTALI_JSON, $portali);
    header('Location: /ASTRA/admin/admin_portal.php?tab=portali'); exit;
}
...
if (isset($_GET['brisi_kodo'])) {
    ...
    adm_pisi($KODE_JSON, $kode);
    header('Location: /ASTRA/admin/admin_portal.php?tab=kode'); exit;
}
...
<script src="/GLOBALNO/frontend/runtime/portali/magic_portali.js"></script>
<script>
(function(){
